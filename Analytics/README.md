...
## Model optimisation
Before using the Holt-Winters model for predictions, the parameters characterising the time series characteristics have to be estimated from the data. Sharing Cities Analystics API uses the following strategy for this:
