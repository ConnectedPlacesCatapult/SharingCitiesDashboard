...
class RequestForData(Resource):
    ...
    def get(self) -> ({str: Any}, int):
        ...
        status_code = 200
        theme, subtheme, attribute_data = None, None, None
        sensor, sensor_name, sensor_attribute = None, None, None
        attributes, sensorid, n_predictions = [], None, 100
        predictions, grouped, harmonising_method = None, None, None
        per_sensor, freq, method = None, '1H', 'mean'
        user_id = None
    ...
    def get_attribute_data(self, attribute_name: str, limit: int, offset: int,
        ...
        for attribute in attributes:
            ...
            _common = {
                ...
                'Attribute_Unit_Description': Unit.get_by_id(
                    attribute.unit_id).description,
                'Attribute_Unit_Value': Unit.get_by_id(
