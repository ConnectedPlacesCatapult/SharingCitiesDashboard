...
class DeleteLocationData(Resource):
    ...
    def __init__(self) -> None:
        ...
        self.reqparser.add_argument('id', required=True, help="LocationData id required", type=int)
    ...
    def post(self) -> (str, HTTPStatus):
        ...
        return dict(error="Location Data id not found", id=str(args["id"])), HTTPStatus.NOT_FOUND
