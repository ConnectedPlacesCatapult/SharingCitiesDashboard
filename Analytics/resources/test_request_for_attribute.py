...
@pytest.mark.parametrize("attribute_param_value", ["temperature",\
 												"NO2,SO2",\
 												"energy_consumed",\
 												"b1_flow_value,b1_temp_out_value, \
 												b1_temp_back_value"
 												])
def test_attribute_params(test_client, attribute_param_value):
	...
	response_fcc_enpoint = test_client.get('/data?{}={}'.format(param,attribute_param_value))
	response_dotmodus_enpoint = test_client.get('/data/{}?{}={}'.format(data,param,attribute_param_value))
...
@pytest.mark.parametrize("attributedata_param_value", ["temperature",\
 												"NO2,SO2",\
 												"energy_consumed",\
...
def test_attributedata_params(test_client, attributedata_param_value):
	...
	response_fcc_enpoint = test_client.get('/data?{}={}'.format(param,attributedata_param_value))
	response_dotmodus_enpoint = test_client.get('/data/{}?{}={}'.format(data,param,attributedata_param_value))
	assert response_dotmodus_enpoint.data == response_fcc_enpoint.data
	assert response_dotmodus_enpoint.status_code == response_fcc_enpoint.status_code

@pytest.mark.parametrize("attributedata,limit,offset", [("temperature","10","0"),\
 												("NO2,SO2","17","2"),\
...
def test_attributedata_limit_and_offset_params(test_client, attributedata,limit,offset):
	...
	response_fcc_enpoint = test_client.get('/data?{}={}&limit={}&offset={}'.format(param,attributedata,limit,offset))
	response_dotmodus_enpoint = test_client.get('/data/{}?{}={}&limit={}&offset={}'.format(data,param,attributedata,limit,offset))
	assert response_dotmodus_enpoint.data == response_fcc_enpoint.data
	assert response_dotmodus_enpoint.status_code == response_fcc_enpoint.status_code

@pytest.mark.parametrize("attributedata,operation,", [("temperature","mean"),\
 												("NO2,SO2","median"),\
