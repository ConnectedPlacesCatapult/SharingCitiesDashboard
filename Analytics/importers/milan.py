    ...
    def _create_datasource(self, headers: Union[str, None] = None) -> None:
        ...
        try:
            ...
            columns = ['device_title', 'device_eui', 'device_description',
                       ...
                       'dimmer_perc',
                       'dimmer_read', 'dimmer_default', 'dimmer_set',
                       'datetime', 'do2',
                       'firmware_version', 'tilt_angle', 'connected_device',
                       'energy_delivered',
                       'di4', 'di5', 'energy_consumed', 'do1', 'di1', 'di2',
                       'di3', 'family_id',
                       'lat', 'lng', 'device_id']
    ...
    def _create_datasource(self, headers: Union[str, None] = None) -> None:
        ...
        try:
            ...
            self.create_datasource(dataframe=self.df, sensor_tag='dev_eui',
                                   ...
                                   bespoke_sub_theme=[],
                                   location_tag=loc, sensor_prefix='',
...
class Milan_API_sensori_meteo(BaseImporter):
    ...
    def __init__(self) -> None:
        ...
        self.BASE_URL += 'data_inizio={0}%2000%3A00%3A01&data_' \
                         'fine={1}%2000%3A00%3A01'.format(
    ...
    def _create_datasource(self, headers: Union[str, None] = None) -> None:
        ...
        try:
            ...
            self.create_datasource(dataframe=df, sensor_tag='plate',
                                   ...
                                   unit_value=[7, 8], bespoke_unit_tag=[],
                                   description=['Information on activities '
                                                'relted to two e-car used by '
                                                'the inhabitants of a '
                                                'condominium located in viale '
                                                'Bacchiglione'],
                                   bespoke_sub_theme=[2, 2], location_tag=loc,
                                   sensor_prefix='',
                                   api_timestamp_tag='api_timestamp_tag')
            self.importer_status.status = Status.success(__class__.__name__)
        except Exception as e:
