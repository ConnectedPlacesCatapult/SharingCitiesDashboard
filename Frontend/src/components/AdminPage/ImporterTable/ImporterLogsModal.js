...
class ImporterLogsModal extends React.Component {
  constructor(props) {
    super(props);
  }
    ...
    return (
      <Paper className={classes.logsModal}>
        <div className={classes.modalHeader}>
          <div style={{flex: 1}}>
            <Typography variant="h6" className={classes.loginPrompt} >
              {this.props.selectedImporter.api_id} | {this.props.selectedImporter.import_class_name}
            </Typography>
          </div>
          <div style={{flex: 1, textAlign: 'right'}}>
            <div className={classes.failureState}>
              <Typography variant="h6" className={classes.failureState}>Reason: {this.props.selectedImporter.reason}</Typography>
            </div>
          </div>
        </div>
        <hr/>
        <div className={classes.logsContainer}>
          <Typography>
            {this.props.selectedImporter.trace}
          </Typography>
        </div>
...
ImporterLogsModal.propTypes = {
  classes: PropTypes.object.isRequired,
  selectedImporter: PropTypes.object.isRequired,
...
ImporterLogsModal = withStyles(styles)(ImporterLogsModal);
ImporterLogsModal = connect(mapStateToProps, mapDispatchToProps)(ImporterLogsModal);

export default ImporterLogsModal
