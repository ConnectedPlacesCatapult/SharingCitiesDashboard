...
class ImporterTableHead extends React.Component {
    ...
    return (
      <TableHead>
        <TableRow>
          ...
          <TableCell padding="checkbox" className={classes.cellBorder}></TableCell>
          <TableCell padding="checkbox" className={classes.cellBorder}></TableCell>
        </TableRow>
      </TableHead>
    )
...
export default withStyles(styles)(ImporterTableHead)
