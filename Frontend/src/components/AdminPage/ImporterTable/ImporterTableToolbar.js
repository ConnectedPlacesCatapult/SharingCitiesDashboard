...
class ImporterTableToolbar extends React.Component {
  render() {
...
ImporterTableToolbar.propTypes = {
  classes: PropTypes.object.isRequired,
  numSelected: PropTypes.number.isRequired,
  onRerunClick: PropTypes.func.isRequired,
};

ImporterTableToolbar = withStyles(styles)(ImporterTableToolbar);

export default ImporterTableToolbar
