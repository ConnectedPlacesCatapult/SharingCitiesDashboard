...
const api = [
  ...
  },
  {
    ...
    "trace": "Traceback (most recent call last):\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/greenwich.py\", line 541, in _create_datasource\n    super()._create_datasource(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 67, in _create_datasource\n    _, status_code = self.load_dataset(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 87, in load_dataset\n    data = requests.get((self.url).replace(' ', '').replace('\\n', '') + self.api_key, headers=headers)\nAttributeError: 'NoneType' object has no attribute 'replace'\n",
  ...
  },
  {
    ...
    "state": "failure",
    "reason": "'NoneType' object has no attribute 'replace'",
    "trace": "Traceback (most recent call last):\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/greenwich.py\", line 335, in _create_datasource\n    super()._create_datasource(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 67, in _create_datasource\n    _, status_code = self.load_dataset(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 87, in load_dataset\n    data = requests.get((self.url).replace(' ', '').replace('\\n', '') + self.api_key, headers=headers)\nAttributeError: 'NoneType' object has no attribute 'replace'\n",
  ...
  },
  {
    ...
    "state": "failure",
    "reason": "'NoneType' object has no attribute 'replace'",
    "trace": "Traceback (most recent call last):\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/greenwich.py\", line 418, in _create_datasource\n    super()._create_datasource(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 67, in _create_datasource\n    _, status_code = self.load_dataset(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 87, in load_dataset\n    data = requests.get((self.url).replace(' ', '').replace('\\n', '') + self.api_key, headers=headers)\nAttributeError: 'NoneType' object has no attribute 'replace'\n",
  ...
  },
  {
    ...
    "state": "failure",
    "reason": "'NoneType' object has no attribute 'replace'",
    "trace": "Traceback (most recent call last):\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/greenwich.py\", line 287, in _create_datasource\n    super()._create_datasource(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 67, in _create_datasource\n    _, status_code = self.load_dataset(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 87, in load_dataset\n    data = requests.get((self.url).replace(' ', '').replace('\\n', '') + self.api_key, headers=headers)\nAttributeError: 'NoneType' object has no attribute 'replace'\n",
  ...
  },
  {
    ...
    "state": "failure",
    "reason": "'lotcode'",
    "trace": "Traceback (most recent call last):\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/lib/python3.7/site-packages/pandas/core/indexes/base.py\", line 2656, in get_loc\n    return self._engine.get_loc(key)\n  File \"pandas/_libs/index.pyx\", line 108, in pandas._libs.index.IndexEngine.get_loc\n  File \"pandas/_libs/index.pyx\", line 132, in pandas._libs.index.IndexEngine.get_loc\n  File \"pandas/_libs/hashtable_class_helper.pxi\", line 1601, in pandas._libs.hashtable.PyObjectHashTable.get_item\n  File \"pandas/_libs/hashtable_class_helper.pxi\", line 1608, in pandas._libs.hashtable.PyObjectHashTable.get_item\nKeyError: 'lotcode'\n\nDuring handling of the above exception, another exception occurred:\n\nTraceback (most recent call last):\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/greenwich.py\", line 213, in _create_datasource\n    names = self.df['lotcode'].tolist()\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/lib/python3.7/site-packages/pandas/core/frame.py\", line 2927, in __getitem__\n    indexer = self.columns.get_loc(key)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/lib/python3.7/site-packages/pandas/core/indexes/base.py\", line 2658, in get_loc\n    return self._engine.get_loc(self._maybe_cast_indexer(key))\n  File \"pandas/_libs/index.pyx\", line 108, in pandas._libs.index.IndexEngine.get_loc\n  File \"pandas/_libs/index.pyx\", line 132, in pandas._libs.index.IndexEngine.get_loc\n  File \"pandas/_libs/hashtable_class_helper.pxi\", line 1601, in pandas._libs.hashtable.PyObjectHashTable.get_item\n  File \"pandas/_libs/hashtable_class_helper.pxi\", line 1608, in pandas._libs.hashtable.PyObjectHashTable.get_item\nKeyError: 'lotcode'\n",
  ...
  },
  {
    ...
    "trace": "Traceback (most recent call last):\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/tfl_bike_points.py\", line 46, in _create_datasource\n    description_tag='sourceSystemKey', api_timestamp_tag='modified')\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 248, in create_datasource_with_values\n    api_timestamp_tag, value_tag, attribute_tag, unit_value_tag)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 492, in insert_data\n    sensor_id = sensor_objects[sensor_prefix + str(sensor_name)].id\nKeyError: 'BikePoints_545'\n",
  ...
  },
  {
    ...
    "state": "failure",
    "reason": "'NoneType' object has no attribute 'replace'",
    "trace": "Traceback (most recent call last):\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/greenwich.py\", line 473, in _create_datasource\n    super()._create_datasource(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 67, in _create_datasource\n    _, status_code = self.load_dataset(headers)\n  File \"/Users/keatonpennels/Documents/FCC/Production/FCCenv/UserStatus/Analytics/importers/base.py\", line 87, in load_dataset\n    data = requests.get((self.url).replace(' ', '').replace('\\n', '') + self.api_key, headers=headers)\nAttributeError: 'NoneType' object has no attribute 'replace'\n",
...
class UserTable extends React.Component {
  ...
  handleUserLogsOpen = (selectedUser) => {
    ...
    return (
      <div className={classes.root}>
          ...
          <div className={classes.tableWrapper}>
            <Table className={classes.table} aria-labelledby="tableTitle">
              ...
              <UserTableBody
                ...
                onLogsClick={this.handleUserLogsOpen}
        ...
        <Modal
          ...
          onClose={this.handleUserLogsClose}
          disableAutoFocus={true}
        >
          <UserLogsModal selectedUser={this.state.selectedUser} onCloseClick={this.handleUserLogsClose}></UserLogsModal>
        </Modal>
